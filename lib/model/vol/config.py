...
CUBE_PARTS_FILE = 'smpl_data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = 'smpl_data/J_regressor_extra.npy'
JOINT_REGRESSOR_H36M = 'smpl_data/J_regressor_h36m.npy'
VERTEX_TEXTURE_FILE = 'smpl_data/vertex_texture.npy'
SMPL_FILE = 'smpl_data/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl'
