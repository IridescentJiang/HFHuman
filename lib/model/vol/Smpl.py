...
class SMPL(nn.Module):
    ...
    def __init__(self, model_file=os.path.join(current_path, cfg.SMPL_FILE)):
        ...
        J_regressor_extra = torch.from_numpy(np.load(os.path.join(current_path, cfg.JOINT_REGRESSOR_TRAIN_EXTRA))).float()
