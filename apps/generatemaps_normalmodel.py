...
from lib.data.NormalDataset import NormalDataset, NormalInferenceDataset
...
if generate_for_inference:
    trained_normal_maps_path = "rendering_script/inference/trained_normal_maps"
    batch_size = 1
else:
...
def generate_maps(opt):
    ...
    if generate_for_inference:
        infer_dataset = NormalInferenceDataset(opt)
    ...
    F_modelnormal_path = "pretrained_model/netF_model_state_dict.pickle" # Date_12_Nov_21_Time_19_17_20 is the folder to use
    B_modelnormal_path = "pretrained_model/netB_model_state_dict.pickle"
